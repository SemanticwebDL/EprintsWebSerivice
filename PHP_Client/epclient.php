...
//        $client = new SoapClient($this->ePrintsHost."/wsdl/SearchServ.wsdl", array("trace" => 1, "exception" => 0, 'cache_wsdl' => WSDL_CACHE_NONE));
    ...
    public function getMetadata() {
        $client = new SoapClient($this->ePrintsHost."/wsdl/MetaDataServ.wsdl", array("trace" => 1, "exception" => 0, 'cache_wsdl' => WSDL_CACHE_NONE));
...
//        var_dump($client->__getLastRequest());
    ...
    public function put() {
        ...
        $ItemObject = new SoapVar($ObjectXML, XSD_ANYXML);
        $client = new SoapClient($this->ePrintsHost."/wsdl/putEprints_string.wsdl", array("trace" => 1, "exception" => 0, 'cache_wsdl' => WSDL_CACHE_NONE));
